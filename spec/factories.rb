...
ActiveRecord::Schema.create_table :"#{Conf.mail_manager_table_prefix}test_users" do |t|
  t.string :first
  t.string :last
  t.string :email
end unless table_exists?("#{Conf.mail_manager_table_prefix}test_users")
...
ActiveRecord::Schema.create_table :"#{Conf.mail_manager_table_prefix}test_mailables", :force => true do |t|
  ...
  t.string :email_html
  t.string :email_text
end unless table_exists?("#{Conf.mail_manager_table_prefix}test_mailables")
